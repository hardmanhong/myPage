window.onload = function() {
    ...
    function isHaveTheEvent(element, eventName) {
        var b = typeof element[eventName] === "undefined" ? false : true;
    }
    if (isHaveTheEvent(eyepetizerVideo, "ontouchstart")) {
    ...
    function getElemByClassname(className, getCollection) {
         ...
         */
    function getJSONP(url, callback, city) {
            //创建一个唯一函数名称。
    ...
    function dailyWeatherCallBack(data) {
            ...
            eyepetizerVideo.innerHTML += "<p>执行了dailyWeatherCallBack<p>";
        }
        /**
    ...
    function nowWeatherCallBack(data) {
            ...
            eyepetizerVideo.innerHTML += "<p>执行了nowWeatherCallBack<p>";
    ...
    function getWeather (city) {
            ...
            eyepetizerVideo.innerHTML = "<p>执行了getWeather<p>";
        }
    /**
     * [init 初始化函数]
     */
     ...
     */
    if (isHaveTheEvent(searchBtn, "ontouchstart")) {
